...
export const VaultyMascot: React.FC<{ size?: number; className?: string; mood?: 'happy' | 'winking' | 'sparkle' }> = ({
  ...
  return (
    ...
    >
      ...
      {/* Main Vault Body (Monochrome) */}
      <rect x="14" y="18" width="72" height="70" rx="18" fill="#18181B" />
      <path
      ...
      <circle cx="50" cy="53" r="22" fill="#F4F4F5" />

      <circle cx="50" cy="53" r="7" fill="#18181B" />
      <rect x="47.5" y="34" width="5" height="7" rx="2.5" fill="#18181B" />
      <rect x="47.5" y="65" width="5" height="7" rx="2.5" fill="#18181B" />
      <rect x="31" y="50.5" width="7" height="5" rx="2.5" fill="#18181B" />
      <rect x="62" y="50.5" width="7" height="5" rx="2.5" fill="#18181B" />
      ...
      {/* Cheeks */}
      <circle cx="37" cy="53" r="3" fill="#000000" fillOpacity="0.1" />
      <circle cx="63" cy="53" r="3" fill="#000000" fillOpacity="0.1" />
      ...
      <line x1="50" y1="18" x2="50" y2="9" stroke="#18181B" strokeWidth="4" strokeLinecap="round" />
      <circle cx="50" cy="7" r="5" fill="#A1A1AA" />
    </svg>
  );
};
  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 text-center">
      ...
      >
        ...
        <circle cx="65" cy="25" r="2.5" fill="#A1A1AA" />
        <circle cx="95" cy="22" r="2" fill="#A1A1AA" />
        <circle cx="55" cy="98" r="2.5" fill="#18181B" />
        <circle cx="70" cy="106" r="2.5" fill="#18181B" />
        <path d="M60 106 Q64 110 68 106" stroke="#18181B" strokeWidth="2" strokeLinecap="round" fill="none" />
      </svg>
